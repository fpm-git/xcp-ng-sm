...
def inflate(journaler, linstor, vdi_uuid, vdi_path, new_size, old_size):
    ...
    linstor_vhd_util = LinstorVhdUtil(None, linstor)
    result_size = linstor_vhd_util.get_size_virt(vdi_uuid)
    ...
    linstor_vhd_util.set_size_phys(vdi_path, result_size, False)
